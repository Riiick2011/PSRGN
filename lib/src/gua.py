...
import Guass1D as _guss_1d

class _Guass1D(Function):
    @staticmethod
    ...
    def backward(ctx, grad_output):
        ...
        grad_input,grad_center,grad_gama = _guss_1d.backward(
            grad_output,
            input,
            rois,
            center,
...
align1d = _Guass1D.apply


class Guass1DLayer(nn.Module):
    def __init__(self, feature_dim,N):
        super(Guass1DLayer, self).__init__()
