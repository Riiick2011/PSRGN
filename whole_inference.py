...
cmd0='python fastai_train.py ./configs/thumos_i3d.yaml'
os.system(cmd0)
...
for j in range(1,61):
    sigma=j/100.0
    print(j)
    cmd = 'python com_inference.py ./configs/thumos_i3d.yaml ./models/epoch_%d_model_GCN.pth'%j+' --sigma 0.28'#+str(sigma)
    os.system(cmd)
