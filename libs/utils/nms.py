...
class NMSop(torch.autograd.Function):
    ...
    def forward(
        ctx, segs,scores,
        iou_threshold, min_score, max_num, cls_idxs=None
    ):
...
class SoftNMSop(torch.autograd.Function):
    @staticmethod
    def forward(
        ctx, segs, scores,iou_threshold, sigma, min_score, method, max_num, cls_idxs=None
    ):
        ...
        if cls_idxs!=None:
            ...
            return sorted_segs.clone(), sorted_scores.clone(),None
