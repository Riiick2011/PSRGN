...
DEFAULTS = {
    ...
    "train_cfg": {
        ...
        "label_smoothing": 0.0,
        "pre_nms_thresh": 0.000,
        "iou_threshold": 0.1,
        "nms_sigma" : 0.23,
        "duration_thresh": 0.00,
    },
    "test_cfg": {
        "pre_cls_nms_thresh": 0.001,
        "cls_iou_threshold": 0.1,
        "nms_method": 'none', # soft | hard | none
        "multiclass_nms": True,
        "ext_score_file": None,
    },
...
def _update_config(config):
    ...
    config["test_cfg"]["num_classes"] = config["dataset"]["num_classes"]
    config["train_cfg"]["test_max_seg_num"] = config["test_cfg"]["test_max_seg_num"]
    config["train_cfg"]["pre_test_nms_topk"] = config["test_cfg"]["pre_test_nms_topk"]
    return config
