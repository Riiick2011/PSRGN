...
def inference(
    ...
    for idx, (vidx, fps, vlen, stride, nframes) in enumerate(
        ...
        final_scores_per_vid=final_scores_per_vid[:,1:].flatten()
...
def main(args):
    ...
    for iter_idx, video_list in enumerate(val_loader,0):
        ...
        with torch.no_grad():
            ...
            fpn_masks,out_cls_logits, out_offsets,rois,scorces,rois_mask,cls_log= model([batched_input,batched_mask])
