...
def main(args):
    ...
    tboard_path = pathlib.Path('/media/user/data/zy/project/Actionformer_two-stage_1/tensorboard/project_5')
    learner.loss_func = pgnloss
    learner.path = learner.path / '/media/user/data/zy/project/Actionformer_two-stage_1'
